...
router.put('/settings', requirePermission('settings'), async (req, res) => {
  try {
    const allowed = ['store_name', 'whatsapp', 'address', 'hours', 'bank_name', 'bank_account_holder', 'bank_account_number', 'bank_extra', 'transfer_note', 'hero_image', 'hero_image_position', 'bank_accounts'];
